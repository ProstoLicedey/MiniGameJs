...
const datasourse_mapper_1 = require("../mapper/datasourse.mapper");
...
let GameRepository = class GameRepository {
    ...
    async save(game) {
        const entity = datasourse_mapper_1.GameMapper.toEntity(game);
    ...
    async getById(id) {
        ...
        return entity ? datasourse_mapper_1.GameMapper.toDomain(entity) : null;
    }
};
